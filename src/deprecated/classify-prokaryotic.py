...
def main(args=None):
    ...
    parser_io.add_argument("-c", "--mags_to_slcs", type=str,  help="path/to/mags_to_slcs.tsv [id_mag]<\t>[id_slc] no header")
    parser_io.add_argument("--blacklist", type=str,  help="path/to/blacklist.list MAGs to blacklist")
