...
def main(args=None):
    ...
    parser_io.add_argument("-M", "--mode", type=str, default="all", help = "prokaryotic,viral,eukaryotic [Default: all]")
    ...
    parser_binning.add_argument("-m", "--minimum_contig_length", type=int, default=1000, help="Minimum contig length.  Anything under 2500 will default to 2500 for MetaBat2 [Default: 1000] ")
