...
**2. It says the total database size is 369G but already have some of the databases downloaded. Can I use these with *VEBA* instead of have redundant databases?**
